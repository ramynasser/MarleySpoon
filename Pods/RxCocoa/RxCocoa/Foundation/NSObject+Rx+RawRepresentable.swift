...
//
    ...
    extension Reactive where Base: NSObject {
         ...
         */
        public func observe<Element: RawRepresentable>(_: Element.Type, _ keyPath: String, options: KeyValueObservingOptions = [.new, .initial], retainSelf: Bool = true) -> Observable<Element?> where Element.RawValue: KVORepresentable {
        ...
        extension Reactive where Base: NSObject {
             ...
             */
            public func observeWeakly<Element: RawRepresentable>(_: Element.Type, _ keyPath: String, options: KeyValueObservingOptions = [.new, .initial]) -> Observable<Element?> where Element.RawValue: KVORepresentable {
